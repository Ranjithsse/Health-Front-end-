        ...
        btnCreateAccount.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (specialty.isEmpty()) {
                    etSpecialty.setError("Specialization is required");
                ...
                RegisterRequest request = new RegisterRequest(username, email, password, specialty, hospital,
                        fullName);
                RetrofitClient.getApiService(DoctorSignUpActivity.this).signup(request)
                        .enqueue(new Callback<AuthResponse>() {
                            ...
                            public void onResponse(Call<AuthResponse> call, Response<AuthResponse> response) {
                                ...
                                if (response.isSuccessful() && response.body() != null) {
                                    ...
                                    Toast.makeText(DoctorSignUpActivity.this, "Signup failed: " + response.message(),
                                            Toast.LENGTH_SHORT).show();
                                }
                            }
                            ...
                            public void onFailure(Call<AuthResponse> call, Throwable t) {
                                btnCreateAccount.setEnabled(true);
                                Toast.makeText(DoctorSignUpActivity.this, "Network Error: " + t.getMessage(),
                                        Toast.LENGTH_SHORT).show();
                            }
                        });
            }
